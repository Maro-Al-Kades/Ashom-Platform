      ...
      <Container>
        <div className="flex flex-col items-center border-t border-gray-200 pb-12 pt-8 md:flex-row md:justify-between md:pt-6">
          <p className="text-xs text-gray-500">
            جميع الحقوق محفوظة. عام {new Date().getFullYear()}&copy;
          </p>
          <form className="flex w-full justify-center md:w-auto mt-6 md:mt-0">
            ...
            />
            <Button type="submit" color="blue" className="mr-4 flex-none">
              <span className="hidden lg:inline">
                اشترك في صحيفتنا الإخبارية
              </span>
              <span className="lg:hidden">انضم إلى النشرة الإخبارية</span>
            </Button>
          </form>
        </div>
      </Container>
